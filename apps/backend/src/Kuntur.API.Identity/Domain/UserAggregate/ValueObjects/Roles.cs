...
internal sealed class Roles : ValueObject
{
    ...
    {
        return string.Join(", ", _roles.Select(r => r.ToString()));
    }
}
...
{
    public static readonly RoleItem MarketplaceAdmin = new()
        { Id = Guid.Parse("597bea85-5b44-4fcb-8ee7-ad3207d43a58"), Name = "marketplace-admin" };

    public static readonly RoleItem SellerAdmin = new()
        { Id = Guid.Parse("01201993-4b2f-4ea7-9412-f739ca27c2ca"), Name = "seller-admin" };

    public static readonly RoleItem Buyer = new()
        { Id = Guid.Parse("941ff82c-c958-4007-b5f5-7893fe189664"), Name = "buyer" };
