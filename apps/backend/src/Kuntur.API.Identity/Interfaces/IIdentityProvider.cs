...
{
    Task<ErrorOr<UserId>> CreateUserAsync(Name name, EmailAddress emailAddress, Password password,
    ...
    Task<ErrorOr<Success>> AddMemberToOrganizationAsync(OrganizationId organizationId, UserId userId,
        CancellationToken ct);
}